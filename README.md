...
- Gunakan tautan file Google Drive yang valid atau URL HTTP(S) yang dapat diakses oleh komputer yang menjalankan SIOMAY; beberapa tautan dapat dipisahkan dengan koma pada kolom yang mendukung banyak gambar.
